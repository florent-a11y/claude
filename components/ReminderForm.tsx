  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/reminders", {
        ...
        body: JSON.stringify({ email, arrivalDate, travelers, nationality: nationality || undefined, productInterest: product, locale, source: source || undefined, consent, website, attribution: getAttribution() }),
      });

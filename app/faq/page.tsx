...
const faqs = [
  ...
  { q: "How is the e-VOA price made up?", a: "The visa fee of IDR 800,000 (about USD 49) is shown separately from our service fee. It includes the IDR 500,000 government e-VOA fee plus card and currency charges. The visa fee is non-refundable once the application is lodged; our service fee is refunded if you are not eligible or we cannot submit." },

...
const faqs = [
  ...
  { q: "Does the arrival card replace a visa?", a: "No. It is an arrival declaration (immigration, customs and health in one form). You still need visa-free entry, a Visa on Arrival, an e-VOA or another visa as applicable." },

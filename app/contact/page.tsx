  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        ...
        <div className="card"><h2 className="font-semibold">WhatsApp</h2>{site.whatsapp ? <a className="mt-2 block text-brand-600 underline" href={`https://wa.me/${site.whatsapp.replace(/\D/g, "")}`}>{site.whatsapp}</a> : <p className="mt-2 text-ink-500">Number published at launch.</p>}</div>
      </div>

...
export async function GET() {
  ...
  const header = ["order_id", "created_at", "status", "assignee", "acknowledged_at", "product", "express", "lead_family_name", "lead_given_names", "nationality", "passport_number", "pax", "arrival_date", "port_of_entry", "flight", "email", "phone", "whatsapp", "amount", "paid_at", "delivered_at", "ops_notes"];
  const rows = orders.map((o) => {
    const t = o.travelers[0];
    return [o.id, o.createdAt, STATUS_LABELS[o.status], o.assignee, o.acknowledgedAt, PRODUCT_LABELS[o.product], o.contact.express ? "yes" : "no", t.familyName, t.givenNames, t.nationality, t.passportNumber, o.travelers.length, o.travel.arrivalDate, o.travel.portOfEntry, o.travel.flightNumber, o.contact.email, o.contact.phone, o.contact.whatsapp ? "yes" : "no", money(o.amountCents, o.currency), o.paidAt, o.deliveredAt, o.opsNotes].map(q).join(",");
  });
